		...
		if(isset($_POST['img']))
		{
			...
			if($model->save()){
                 ...
                 if($modelRelComics->save()){
                    $this->ShareComic($my_access_token,'https://memegenerator.in2teck.com/Comics/'.$filename,'¿Qué te parece mi Meme? Lo hice en el Especial Meme Generator:  http://www.facebook.com/JCEspecial/app_342733185828640');
