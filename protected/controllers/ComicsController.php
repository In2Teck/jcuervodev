		...
		if(isset($_POST['img']))
		{
			...
			if($model->save()){
                 ...
                 if($modelRelComics->save()){
                    $this->ShareComic($my_access_token,'https://198.101.242.113/jcuervodev/Comics/'.$filename,'¿Qué te parece mi Meme? Lo hice en el Especial Meme Generator:  http://www.facebook.com/JCEspecial/app_342733185828640');
