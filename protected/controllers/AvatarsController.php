...
class AvatarsController extends Controller
{
  ...
  public function actionUpdateImg(){
  	if(isset($_POST['img']) && Yii::app()->session['usuario_id'] ){
	    ...
	    $this->ShareMemeLink($my_access_token,'https://memegenerator.in2teck.com/Avatar/'.$filename,'Mi Avatar para el Especial Meme Generator. Crea el tuyo aquí: http://www.facebook.com/JCEspecial/app_342733185828640');
