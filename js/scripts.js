...
//navigation menu
  $(".menu").live("click",function(){
      ...
      $.ajax({
          type: "GET",
          url: window.protocol+"198.101.242.113/jcuervodev/index.php/App/"+url,
  ...
  $('.mismemesmenu').live("click",function(){   
   $.ajax({
          type: "GET",
          url: window.protocol+"198.101.242.113/jcuervodev/index.php/App/mismemes",
          success: function(data){
            $("#container").html(data);
          }
        });
  ...
  $(".cdetail").live('click',function(){
     var comicid=$(this).attr('id');
        $.ajax({
            ...
            url: window.protocol+"198.101.242.113/jcuervodev/index.php/UsuariosHasTblComics/UpdateViews",
            success: function(data){
  ...
  $(".com").live('click',function(){
        ...
        if(comentario.length != 0 && comentario != false){
          $.ajax({
            ...
            url: window.protocol+"198.101.242.113/jcuervodev/index.php/UsuariosComicsComentarios/create",
            success: function(data){
               $("#comics").html(data);
               $('#com').val('');
  ...
  $(".delc").live('click',function(){
    if (confirm('Realmete deseas eliminar este Meme')) {
          ...
          $.ajax({
            type: "POST",
            url: window.protocol+"198.101.242.113/jcuervodev/index.php/Comics/delete/"+comicid,
            success: function(data){
  ...
  $(".delcom").live('click',function(){
    if (confirm('Realmete deseas eliminar este comentario')) {
          ...
          $.ajax({
            type: "POST",
            url: window.protocol+"198.101.242.113/jcuervodev/index.php/UsuariosComicsComentarios/delete/"+comenid,
            success: function(data){
...
$(".share").live('click',function(){
    ...
    $.ajax({
      type: "POST",
      data:"id="+comicid,
      url: window.protocol+"198.101.242.113/jcuervodev/index.php/comics/share/"+comicid,
      success: function(data){
    ...
    var obj = {
      method: 'feed',
      redirect_uri: window.protocol+"198.101.242.113/jcuervodev/index.php",
      link: window.protocol+"198.101.242.113/jcuervodev/index.php",
...
$('#spic').live('click',function(){
  if(parseInt(w)){
      $.ajax({
            ...
            url: window.protocol+"198.101.242.113/jcuervodev/index.php/CaraWeb/Edit",
            success: function(data){
              parent.tmp="/tmp/";
