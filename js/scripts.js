...
//navigation menu
  $(".menu").live("click",function(){
      ...
      $.ajax({
          type: "GET",
          url: window.protocol+"memegenerator.in2teck.com/index.php/App/"+url,
  ...
  $('.mismemesmenu').live("click",function(){   
   $.ajax({
          type: "GET",
          url: window.protocol+"memegenerator.in2teck.com/index.php/App/mismemes",
          success: function(data){
            $("#container").html(data);
          }
        });
  ...
  $(".cdetail").live('click',function(){
     var comicid=$(this).attr('id');
        $.ajax({
            ...
            url: window.protocol+"memegenerator.in2teck.com/index.php/UsuariosHasTblComics/UpdateViews",
            success: function(data){
  ...
  $(".com").live('click',function(){
        ...
        if(comentario.length != 0 && comentario != false){
          $.ajax({
            ...
            url: window.protocol+"memegenerator.in2teck.com/index.php/UsuariosComicsComentarios/create",
            success: function(data){
               $("#comics").html(data);
               $('#com').val('');
  ...
  $(".delc").live('click',function(){
    if (confirm('Realmete deseas eliminar este Meme')) {
          ...
          $.ajax({
            type: "POST",
            url: window.protocol+"memegenerator.in2teck.com/index.php/Comics/delete/"+comicid,
            success: function(data){
  ...
  $(".delcom").live('click',function(){
    if (confirm('Realmete deseas eliminar este comentario')) {
          ...
          $.ajax({
            type: "POST",
            url: window.protocol+"memegenerator.in2teck.com/index.php/UsuariosComicsComentarios/delete/"+comenid,
            success: function(data){
...
$(".share").live('click',function(){
    ...
    $.ajax({
      type: "POST",
      data:"id="+comicid,
      url: window.protocol+"memegenerator.in2teck.com/index.php/comics/share/"+comicid,
      success: function(data){
...
$('#spic').live('click',function(){
  if(parseInt(w)){
      $.ajax({
            ...
            url: window.protocol+"memegenerator.in2teck.com/index.php/CaraWeb/Edit",
            success: function(data){
              parent.tmp="/tmp/";
